...
constructor() {}
		...
		getUrlCambiaPassword():String{
	  			return this.URLcambiapassword='http://localhost:808/Tramites/controladorregistro?operacion=apiSolicitanteCambioPassword&id_solicitante=';
	  	}

		  getUrlupload():String{
	  			return this.URLupload='http://localhost:8081/upload';
	  	}
